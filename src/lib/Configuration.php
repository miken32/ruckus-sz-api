...
namespace PofP\SmartzoneClient;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://10.0.0.10:8443/wsg/api/public/v11_1';
    ...
    {
        $report  = 'PHP SDK (PofP\SmartzoneClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v11_1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://10.0.0.10:8443/wsg/api/public/v11_1",
