...
/**
 * ApQueryQueryCriteria Class Doc Comment
 *
 * @category Class
 * @package  PofP\SmartzoneClient
 * @author   OpenAPI Generator team
 ...
 */
class ApQueryQueryCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'apQuery_queryCriteria';
    ...
    */
     ...
     * Sets options
     *
     * @param object|null $options specified feature required informaion
     *
     * @return self
     */
