...
/**
 * VendorSpecificAttributeProfileCreateResult Class Doc Comment
 *
 * @category Class
 * @package  PofP\SmartzoneClient
 * @author   OpenAPI Generator team
 ...
 */
class VendorSpecificAttributeProfileCreateResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vendorSpecificAttributeProfile_createResult';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier of the vendor specific attribute profile
     *
     * @return self
     */
